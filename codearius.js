...
client.on("guildMemberAdd", (member, message) => {
  const sunucuid = "778941274178715681"; //Sunucu id
  const id = "778951538340528140"; //Kanal id
  const jail = "778951407185166336"; //jail rol id
  const kayıtsız = "778951422212309002";
  const kayıtsız2 = "778951423051956236";//Kayıtsız rol id
  let resim = "https://cdn.discordapp.com/attachments/745297052883222528/777088136198488084/Woman_Gif_30.gif"
...
Kayıt olmak için <@&779775087117074443> rolündeki yetkilileri etiketlemeyi unutma.`)
